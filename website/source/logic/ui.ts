export enum ElementID {
    CATECHISM_CONTENT_PREVIOUS_LINK_WRAPPER = 'catechism-content-previous-link-wrapper',
    ...
    TOOLBAR_MENU_CLOSE_BUTTON = 'toolbar-menu-close',
    TOOLBAR_MENU_CLOSE_BUTTON_SELECTOR = '#toolbar-menu-close',
    ...
    TOOLBAR_MENU_LANGUAGE_TRIGGER = 'toolbar-menu-language-trigger',
    TOOLBAR_MENU_LANGUAGE_TRIGGER_SELECTOR = '#toolbar-menu-language-trigger',
